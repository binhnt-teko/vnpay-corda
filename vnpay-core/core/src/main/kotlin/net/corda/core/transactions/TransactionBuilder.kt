...
open class TransactionBuilder(
    ...
    fun copy(): TransactionBuilder {
        log.info("binhnt: TransactionBuilder.copy: copy new transaction")
    ...
    fun withItems(vararg items: Any) = apply {
        log.info("binhnt: TransactionBuilder.withItems: for each item => apply sttte")
    ...
    internal fun toWireTransactionWithContext(services: ServicesForResolution, serializationContext: SerializationContext? = null): WireTransaction {
        log.info("binhnt: TransactionBuilder.toWireTransactionWithContext: start")
    ...
    private fun addMissingDependency(services: ServicesForResolution, wireTx: WireTransaction): Boolean {
        log.info("binhnt: TransactionBuilder.addMissingDependency: start")
    ...
    private fun selectContractAttachmentsAndOutputStateConstraints(
        log.info("binhnt: TransactionBuilder.selectContractAttachmentsAndOutputStateConstraints: start")
    ...
    private fun handleContract(
        ...
        log.info("binhnt: TransactionBuilder.handleContract: start")
