...
class PersistentStateService(private val schemaService: SchemaService) {
    ...
    fun persist(produced: Set<StateAndRef<ContractState>>) {
        log.info("binhnt: PersistentStateService.persist: call schema and put value")
    ...
    internal fun persistStatesWithSchema(statesAndRefs: List<ContractStateAndRef>, schema: MappedSchema) {
        log.info("binhnt: PersistentStateService.persistStatesWithSchema: call schemaService and generateMappedObject")
        ...
        statesAndRefs.forEach {
            ...
            log.info("binhnt: PersistentStateService.persistStatesWithSchema: call store object currentDBSession")
