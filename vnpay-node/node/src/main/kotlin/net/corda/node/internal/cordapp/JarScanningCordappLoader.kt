...
class JarScanningCordappLoader private constructor(private val cordappJarPaths: List<RestrictedURL>,
    ...
    init {
        logger.info("Binhnt: JarScanningCordappLoader.init start")
    ...
    companion object {
        ...
        fun fromDirectories(cordappDirs: Collection<Path>,
            ...
            logger.info("binhnt: JarScanningCordappLoader.fromDirectories: Looking for CorDapps in ${cordappDirs.distinct().joinToString(", ", "[", "]")}")
        ...
        fun fromJarUrls(scanJars: List<URL>, versionInfo: VersionInfo = VersionInfo.UNKNOWN, extraCordapps: List<CordappImpl> = emptyList(),
            ...
            logger.info("Binhnt: JarScanningCordappLoader.fromJarUrls start")
        ...
        private fun jarUrlsInDirectory(directory: Path): List<URL> {
            logger.info("Binhnt: JarScanningCordappLoader.jarUrlsInDirectory: get list jar file")
    ...
    private fun loadCordapps(): List<CordappImpl> {
        logger.info("Binhnt: JarScanningCordappLoader.loadCordapps: load Cordapps from folder using $cordappJarPaths")
        val cordapps = cordappJarPaths
                ...
                .filter {
                    logger.info("Binhnt: JarScanningCordappLoader.loadCordapps: filter by  blacklist ")
        ...
        logger.info("Binhnt: JarScanningCordappLoader.loadCordapps: foreach cordapp call CordappResolver::register ")
    ...
    private fun scanCordapp(cordappJarPath: RestrictedURL): RestrictedScanResult {
        logger.info("binhnt: JarScanningCordappLoade.scanCordapp: Scanning CorDapp in ${cordappJarPath.url} and store in cached")
        return cachedScanResult.computeIfAbsent(cordappJarPath) {
            logger.info("binhnt: JarScanningCordappLoade.scanCordapp: Scanning CorDapp in url because not cached using ClassGraph")
...
abstract class CordappLoaderTemplate : CordappLoader {
    override val flowCordappMap: Map<Class<out FlowLogic<*>>, Cordapp> by lazy {
        println("Binhnt: JarScanningCordappLoader.fromJarUrls start")
