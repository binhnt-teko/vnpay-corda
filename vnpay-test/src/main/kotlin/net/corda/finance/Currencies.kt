...
fun VNDS(amount: Int): Amount<Currency> = AMOUNT(amount, VND)
fun VNDS(amount: Long): Amount<Currency> = AMOUNT(amount, VND)
fun VNDS(amount: Double): Amount<Currency> = AMOUNT(amount, VND)
...
val Int.VNDS: Amount<Currency> get() = VNDS(this)
val Long.VNDS: Amount<Currency> get() = VNDS(this)
val Double.VNDS: Amount<Currency> get() = VNDS(this)
