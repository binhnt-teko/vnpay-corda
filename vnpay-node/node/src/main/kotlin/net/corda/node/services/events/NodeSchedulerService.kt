...
class NodeSchedulerService(private val clock: CordaClock,
    ...
    companion object {
        ...
        fun awaitWithDeadline(clock: CordaClock, deadline: Instant, future: Future<*> = GuavaSettableFuture.create<Any>()): Boolean {
            staticLog.info("binhnt:NodeSchedulerService.awaitWithDeadline: stat" )
            var nanos: Long
            do {
    ...
    fun start() {
        println("binhnt:NodeSchedulerService.need: stat" )
        schedulerTimerExecutor.execute { runLoopFunction() }
    }

    override fun scheduleStateActivity(action: ScheduledStateRef) {
        println("binhnt:NodeSchedulerService.scheduleStateActivity: stat" )
        ...
        println("binhnt:NodeSchedulerService.scheduleStateActivity: call contextTransaction" )
    ...
    private fun runLoopFunction() {
        println("binhnt:NodeSchedulerService.runLoopFunction: stat" )
    ...
    private fun onTimeReached(scheduledState: ScheduledStateRef) {
        println("binhnt:NodeSchedulerService.onTimeReached: stat" )
    ...
    private fun getFlow(scheduledState: ScheduledStateRef): FlowLogic<*>? {
        println("binhnt:NodeSchedulerService.getFlow: stat" )
    ...
    private fun getScheduledActivity(scheduledState: ScheduledStateRef): ScheduledActivity? {
        println("binhnt:NodeSchedulerService.getScheduledActivity: stat" )
