...
class FlowLogicRefFactoryImpl(private val classloader: ClassLoader) : SingletonSerializeAsToken(), FlowLogicRefFactory {
    ...
    override fun create(flowClass: Class<out FlowLogic<*>>, vararg args: Any?): FlowLogicRef {
        println("Binhnt: FlowLogicRefFactoryImpl.create:  check annotation is SchedulableFlow")
        ...
        println("Binhnt: FlowLogicRefFactoryImpl.create:  call createForRPC")
    ...
    override fun createForRPC(flowClass: Class<out FlowLogic<*>>, vararg args: Any?): FlowLogicRef {
        ...
        println("Binhnt: FlowLogicRefFactoryImpl.createForRPC:  set up parameters to call via rpc")
        ...
        println("Binhnt: FlowLogicRefFactoryImpl.createForRPC:  Build map of args from array")
        // Build map of args from array
        val argsMap = args.zip(constructor.parameters).map { Pair(it.second.name!!, it.first) }.toMap()

        println("Binhnt: FlowLogicRefFactoryImpl.createForRPC:  call createKotlin ")
    ...
    internal fun createKotlin(type: Class<out FlowLogic<*>>, args: Map<String, Any?>): FlowLogicRef {
        ...
        println("binhnt: FlowLogicRefFactoryImpl.createKotlin: create constructor for type")
        createConstructor(type, args)

        println("binhnt: FlowLogicRefFactoryImpl.createKotlin: call FlowLogicRefImpl")
        return FlowLogicRefImpl(type.name, args)
    }

    override fun toFlowLogic(ref: FlowLogicRef): FlowLogic<*> {
        println("binhnt: FlowLogicRefFactoryImpl.toFlowLogic: check  FlowLogicRef")
        ...
        println("binhnt: FlowLogicRefFactoryImpl.toFlowLogic: call createConstructor to create FlowLogis pointer")
    ...
    private fun createConstructor(clazz: Class<out FlowLogic<*>>, args: Map<String, Any?>): () -> FlowLogic<*> {
        println("binhnt: FlowLogicRefFactoryImpl.createConstructor: build constructor ")
    ...
    private fun buildParams(constructor: KFunction<FlowLogic<*>>, args: Map<String, Any?>): HashMap<KParameter, Any?>? {
        ...
        println("binhnt: FlowLogicRefFactoryImpl.buildParams: start ")
    ...
    private fun tryBuildParam(args: Map<String, Any?>, parameter: KParameter, params: HashMap<KParameter, Any?>): Boolean {
        println("binhnt: FlowLogicRefFactoryImpl.tryBuildParam: start ")
