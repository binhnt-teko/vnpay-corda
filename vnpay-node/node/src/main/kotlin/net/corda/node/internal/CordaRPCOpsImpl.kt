...
internal class CordaRPCOpsImpl(
    ...
    init {
        logger.info("binhnt: CordaRPCOpsImpl.init: start ")
    ...
    override fun networkMapSnapshot(): List<NodeInfo> {
        logger.info("binhnt: CordaRPCOpsImpl.networkMapSnapshot: start ")
    ...
    override fun networkParametersFeed(): DataFeed<ParametersUpdateInfo?, ParametersUpdateInfo> {
        logger.info("binhnt: CordaRPCOpsImpl.networkParametersFeed: start ")
        return services.networkMapUpdater.trackParametersUpdate()
    }

    override fun acceptNewNetworkParameters(parametersHash: SecureHash) {
        logger.info("binhnt: CordaRPCOpsImpl.acceptNewNetworkParameters: start ")
    ...
    override fun <T : ContractState> vaultQueryBy(criteria: QueryCriteria,
        ...
        logger.info("binhnt: CordaRPCOpsImpl.vaultQueryBy: start ")
    ...
    override fun <T : ContractState> vaultTrackBy(criteria: QueryCriteria,
        ...
        logger.info("binhnt: CordaRPCOpsImpl.vaultTrackBy: start ")
        contractStateType.checkIsA<ContractState>()
    ...
    override fun internalVerifiedTransactionsSnapshot(): List<SignedTransaction> {
        logger.info("binhnt: CordaRPCOpsImpl.internalVerifiedTransactionsSnapshot: start ")
    ...
    override fun internalVerifiedTransactionsFeed(): DataFeed<List<SignedTransaction>, SignedTransaction> {
        logger.info("binhnt: CordaRPCOpsImpl.internalVerifiedTransactionsFeed: start ")

        return services.validatedTransactions.track()
    }

    override fun stateMachinesSnapshot(): List<StateMachineInfo> {
        logger.info("binhnt: CordaRPCOpsImpl.stateMachinesSnapshot: start ")
    ...
    override fun stateMachinesFeed(): DataFeed<List<StateMachineInfo>, StateMachineUpdate> {
        logger.info("binhnt: CordaRPCOpsImpl.stateMachinesFeed: start ")
    ...
    override fun stateMachineRecordedTransactionMappingSnapshot(): List<StateMachineTransactionMapping> {
        logger.info("binhnt: CordaRPCOpsImpl.stateMachineRecordedTransactionMappingSnapshot: start ")
    ...
    override fun nodeInfo(): NodeInfo {
        logger.info("binhnt: CordaRPCOpsImpl.nodeInfo: start ")
    ...
    override fun <T> startTrackedFlowDynamic(logicType: Class<out FlowLogic<T>>, vararg args: Any?): FlowProgressHandle<T> {
        logger.info("binhnt: CordaRPCOpsImpl.startTrackedFlowDynamic: start ")
    ...
    override fun <T> startFlowDynamic(logicType: Class<out FlowLogic<T>>, vararg args: Any?): FlowHandle<T> {
        logger.info("binhnt: CordaRPCOpsImpl.startFlowDynamic: start ")

        logger.info("binhnt: CordaRPCOpsImpl.startFlowDynamic: get statemachine =  startFlow")
        val stateMachine = startFlow(logicType, args)

        logger.info("binhnt: CordaRPCOpsImpl.startFlowDynamic: call FlowHandleImpl")
        return FlowHandleImpl(id = stateMachine.id, returnValue = stateMachine.resultFuture)
    }

    private fun <T> startFlow(logicType: Class<out FlowLogic<T>>, args: Array<out Any?>): FlowStateMachine<T> {
        logger.info("binhnt: CordaRPCOpsImpl.startFlow: start ")
        ...
        logger.info("binhnt: CordaRPCOpsImpl.startFlow: flowStarter.invokeFlowAsync ")
        return flowStarter.invokeFlowAsync(logicType, context(), *args).getOrThrow()
    }

    override fun attachmentExists(id: SecureHash): Boolean {
        logger.info("binhnt: CordaRPCOpsImpl.attachmentExists: start ")

        return services.attachments.openAttachment(id) != null
    }

    override fun openAttachment(id: SecureHash): InputStream {
        logger.info("binhnt: CordaRPCOpsImpl.openAttachment: start ")
    ...
    override fun queryAttachments(query: AttachmentQueryCriteria, sorting: AttachmentSort?): List<AttachmentId> {
        logger.info("binhnt: CordaRPCOpsImpl.queryAttachments: start ")
    ...
    override fun wellKnownPartyFromX500Name(x500Name: CordaX500Name): Party? {
        logger.info("binhnt: CordaRPCOpsImpl.wellKnownPartyFromX500Name: start ")
    ...
    override fun terminate(drainPendingFlows: Boolean) {
        logger.info("binhnt: CordaRPCOpsImpl.terminate: start ")
    ...
    private fun InvocationContext.toFlowInitiator(): FlowInitiator {
        logger.info("binhnt: CordaRPCOpsImpl.InvocationContext.toFlowInitiator: start ")
